  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-dark-bg to-dark-bg flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20">
        <div className="absolute top-10 -right-32 w-72 h-72 bg-primary-500 rounded-full mix-blend-multiply filter blur-3xl"></div>
        <div className="absolute -bottom-20 -left-32 w-96 h-96 bg-accent-500 rounded-full mix-blend-multiply filter blur-3xl"></div>
      </div>
        ...
        <div className="hidden lg:flex w-1/2 items-center justify-center">
          <div className="relative w-full h-full flex items-center justify-center">
            ...
            <div className="relative">
              ...
              {/* Decorative rings */}
              <div className="absolute -inset-4 border-2 border-primary-500/30 rounded-3xl animate-pulse"></div>
              <div className="absolute -inset-8 border border-accent-500/20 rounded-3xl"></div>
            </div>

            {/* Floating Text */}
            <div className="absolute bottom-20 text-center">
              <h2 className="text-3xl font-bold text-white mb-2">Welcome to TaskFlow</h2>
              <p className="text-dark-textSecondary text-lg">Collaborative task management made simple</p>
            </div>
          </div>
        </div>
          ...
          <div className="w-full max-w-md">
            ...
            <div className="bg-dark-card/60 backdrop-blur-xl rounded-2xl border border-dark-border p-8 shadow-2xl">
              <div className="mb-8">
                ...
                <p className="text-dark-textSecondary">Login to your TaskFlow account</p>
              </div>
